...
class FTIMVoiceSimple extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _FTIMVoiceSimpleState(control: control);
}

class _FTIMVoiceSimpleState extends State<FTIMVoiceSimple>
  ...
  void initState() {
    ...
    _animation =
        CurvedAnimation(curve: Curves.linear, parent: _animationControl)
          ..addListener(() {
            setState(() {});
          });
